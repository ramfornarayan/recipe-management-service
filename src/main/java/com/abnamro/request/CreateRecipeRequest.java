...
public class CreateRecipeRequest {
	...
	@Schema(description = "The type of the recipe", example = "VEGETARIAN", allowableValues = { "VEGETARIAN",
	...
	public CreateRecipeRequest(String recipeName, String type, int numberOfServings, List<Integer> ingredientIds,
			String instructions) {
