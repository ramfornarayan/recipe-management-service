...
import com.abnamro.recipe.response.GenericResponse;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<GenericResponse> handleMissingParam(
            MissingServletRequestParameterException ex) {

        return ResponseEntity.badRequest()
                .body(new GenericResponse("Missing request parameter: " + ex.getParameterName()));
    }
}
